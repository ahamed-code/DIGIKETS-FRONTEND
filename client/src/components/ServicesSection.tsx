...
import { Search, Share2, FileText, Target, Code, BarChart3 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <Card className="h-full hover-elevate active-elevate-2 transition-all duration-300 bg-card/50 backdrop-blur-sm border-primary/20" data-testid={`service-card-${index}`}>
                <CardHeader>
